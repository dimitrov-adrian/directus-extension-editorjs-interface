...
.search-input .icon-empty {
	--v-icon-color: var(--foreground-subdued);
	display: none;
	margin-left: 8px;
}
.search-input .icon-empty:hover {
	--v-icon-color: var(--danger);
}
.search-input .icon-search, .search-input .icon-filter {
...
.search-input.has-content .icon-empty {
	display: block;
}
.search-input.has-content .icon-filter {
	margin-left: 0;
}
.search-input.active {
	width: 300px;
...
.search-input.active .icon-empty {
	display: block;
}
